...
public class Client {
    public static void main(String[] args) {
        ...
        ManageStaffInterface staffManage = new ManageStaff();
        FileOperateInterfaceV2 fileOperator = new Adapter(adaptee, staffManage);
        Scanner input = new Scanner(System.in);
        System.out.println("Please select operation: 1.readFile 2.listFile 3. writeByName 4.writeByRoom 5.addStaff 6.removeStaff:");
        int op = 0;
        do {
            try {
                op = input.nextInt();
