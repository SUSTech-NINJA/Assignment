...
public class RefactorFinalTest {
    ...
    public void Test01ParkingHours() {
        Assertions.assertEquals("1.3", String.format("%.1f", p1.getParkingHours()));
        Assertions.assertEquals("0.2", String.format("%.1f", p2.getParkingHours()));
        Assertions.assertEquals("48.5", String.format("%.1f", p3.getParkingHours()));
        Assertions.assertEquals("1.0", String.format("%.1f", p4.getParkingHours()));
        Assertions.assertEquals("0.2", String.format("%.1f", p5.getParkingHours()));
        Assertions.assertEquals("46.7", String.format("%.1f", p6.getParkingHours()));
        Assertions.assertEquals("12.7", String.format("%.1f", p7.getParkingHours()));
        Assertions.assertEquals("1.8", String.format("%.1f", p8.getParkingHours()));
        Assertions.assertEquals("40.5", String.format("%.1f", p9.getParkingHours()));
    }
    ...
    public void Test02CarOwner1() {
        ...
        Assertions.assertEquals("[owner1] Parting 3 times, cost 150 RMB, activePoints is 7",
                c.toString());
        ...
        for (int i = 0; i < c.getParkingRecords().size(); i++) {
            Assertions.assertEquals(results.get(i), c.getParkingRecords().get(i).toString());
        }
    }
    ...
    public void Test03CarOwner2() {
        ...
        Assertions.assertEquals("[owner2] Parting 3 times, cost 215 RMB, activePoints is 10",
                c.toString());
        List<String> results = new ArrayList<>();
    ...
    public void Test04CarOwner3() {
        ...
        Assertions.assertEquals("[owner3] Parting 3 times, cost 170 RMB, activePoints is 5",
                c.toString());
        List<String> results = new ArrayList<>();
    ...
    public void TestStrategyClass() {
        try {
            ...
            Assertions.assertEquals(strategyClz.getName(), internalClz.getSuperclass().getName());
            Assertions.assertEquals(strategyClz.getName(), vipClz.getSuperclass().getName());
            Assertions.assertEquals(strategyClz.getName(), externalClz.getSuperclass().getName());
            Assertions.assertTrue(Modifier.isAbstract(strategyClz.getModifiers()), "Calculate class should be abstract");
            ...
            Assertions.assertTrue(Modifier.isAbstract(parkingPriceMethod.getModifiers()));
            Assertions.assertTrue(Modifier.isAbstract(pointsMethod.getModifiers()));
    ...
    public void TestContextClass() {
        try {
            ...
            Assertions.assertNotNull(field, "can not find the Field Calculate");
            ...
            Assertions.assertNotNull(setCalculateMethod);
            Assertions.assertNotNull(parkingPriceMethod);
            Assertions.assertNotNull(increasePointsMethod);
            ...
            Assertions.assertEquals(15, parkingPriceMethod.invoke(carObj, 5));
            Assertions.assertEquals(2, increasePointsMethod.invoke(carObj, 4));
